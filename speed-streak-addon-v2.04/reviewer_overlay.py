...
class ReviewerOverlayController:
    ...
    def preview_audio_feedback_from(
        ...
        return self.audio_feedback.play_from_position(
            self.audio_feedback.normalize_file(file_name),
            position_ms,
            volume_percent,
        )
    ...
    def prepare_countdown_audio_preview(
        ...
        return self.audio_feedback.prepare_timed(
            self.audio_feedback.normalize_file(file_name),
            volume_percent,
        )

    def countdown_audio_preview_ready(self, file_name: str) -> bool:
        return self.audio_feedback.timed_ready(self.audio_feedback.normalize_file(file_name))
    ...
    def preview_countdown_audio(
        ...
        return self.audio_feedback.play_timed(
            self.audio_feedback.normalize_file(file_name),
            volume_percent,
        )
    ...
    def on_profile_did_open(self, *_args: Any) -> None:
        ...
        try:
            if next_root.resolve() == self.data_root.resolve():
                return
        except Exception:
            if str(next_root) == str(self.data_root):
                return
    ...
    def _on_countdown_cue_due(self) -> None:
        ...
        self._countdown_cue_fired_seconds.add(schedule.second)
        self.audio_feedback.play_timed(
            state.countdown_audio_file,
            state.countdown_audio_volume,
        )
        self._sync_countdown_audio()
