...
- Keeps the v2.0 WebGL renderer and window preset work.
- Removes the temporary testing control for manually setting the streak/satellite count.
- Installs as `speed_streak_v1_20`.
